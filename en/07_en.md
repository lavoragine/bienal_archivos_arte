---
axis: "Memory and oblivion in documentation policies: What and how we select, conserve, systematise and disseminate".
...
reading_order: 7
abstract: | 
The Centro de Documentación de las Artes Visuales was inaugurated in 2006 in Santiago de Chile. At the time, it was defined as an archive specialising in contemporary Chilean visual arts production from the 1970s to the present day.

Since its inauguration, its aim has been to fill a gap in the safeguarding of and access to documentary heritage linked to the visual arts, compiling, managing, conserving and disseminating fundamental sources for the history of art in Chile. The collection it has assembled is made up of archival documents, works (video art), publications, artist's books, among other types of documents that show the blurred boundaries when thinking about classifications such as works and documents.

Situating CEDOC in a specific policy such as the *National Policy for the Visual Arts 2017 - 2022* presents great challenges and the aim of this paper is to share the programmes and lines of work that seek to "Contribute to the promotion, safeguarding and recognition of collections and archives linked to the visual arts throughout the country", as the policy states.

The challenge of working with archives that reflect the functions and actions of those who produce them, be they artists or institutions in the field of art, invites us to reflect on the importance and necessity of delving into the history of archival institutions, with the aim of sharing the criteria and decisions that have shaped the collections in a post-custodial context, also delving into relevant conceptual issues that make us wonder about the use of archival principles in working with funds and collections.
...
...
![Invitation to the opening of CEDOC in La Moneda Cultural Center, July 7, 2006](../07/image1.png)
...
![Current exhibits inside the National Center of Contemporary Art. Picture by Sebastian Mejia, 2019.](../07/image2.png)
