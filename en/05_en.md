---
axis: 'Memory and forgetting in documentation policies: what and how do we select, preserve, systematise and disseminate?
title: 'Materials and methods for the drafting of the MSSA Archiving Policy'.
author:
    name: 'Isabel Cáceres'
    affiliation: 'Salvador Allende Solidarity Museum'
reading_order: 5
---
...
![Pic. 3: MSSA Archive is an active area of the museum, it serves different purposes and activities, from the remote access to its holdings and collections, the dissemination of the investigations, and the publishing of its policies and support to exhibits.](05/image_2.jpg)
