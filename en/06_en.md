...
Image library (*Imagoteca*): CeDInCI, collection of social and political images. Reflections on its construction.

Natalia Efron and M. Eugenia Sik
...
## History of the Image Library (*Imagoteca*)[^2]
...
**Pic. 1: Screenshot from the *Imagoteca’s* homepage (2016)**
...
-   The slim web development required from AtoM (an almost ready system).
...
**Pic. 2: Example of a register in the 2016 *Imagoteca***
...
**Pic. 3: Home page of the current *Imagoteca* (2021)**
...
1.  **Why build a curatorship of the images in a collection?**
...
>
> **Pic. 4: Portrait of Deolindo Felipe Bittel. Hugo Gambini Holding.**
>
> **Pic. 5: Record of the portrait of Deolindo Felipe Bittel (Pic. 4). There, hyperlinked fields can be observed, among them, the grouping within the Imagoteca on the Gambini Holding, and the link to the archival description of the AtoM system.**
>
> **Pic. 6. Description of the BITTEL Deolindo Felipe envelope from the Gabini Holding in the AtoM system.**

1.  **When a Holding/Collection is composed of many types of documentation, how do we establish clear criteria and delimitations that allow us to select and develop the site?**
...
**Pic. 7 & 8. On ‘Alicia Margarita Cena (missing minor). *La Razón* newspaper Holding.**

**Pic. 9. Posters from the collection of political cultural posters of CeDInCI**

1.  **Questions and challenges in the image’s description**
